...
export default function HandwerkerLVDetailsPage() {
  ...
  const discountAmount = bundleDiscount > 0 ? (total * bundleDiscount / 100) : 0;
  const nettoAfterDiscount = total - discountAmount;
  ...
  onClick={() => {
    ...
    const bauherrData = sessionStorage.getItem('userData') || sessionStorage.getItem('bauherrData');
