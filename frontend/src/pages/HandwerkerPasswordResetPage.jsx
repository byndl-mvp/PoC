// src/components/HandwerkerPasswordResetPage.jsx
import React, { useState, useEffect } from 'react';
import { useSearchParams, useNavigate, Link } from 'react-router-dom';
import { apiUrl } from '../api';

export default function HandwerkerPasswordResetPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(apiUrl('/api/handwerker/reset-password'), {
        method: 'POST',
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 flex items-center justify-center">
      ...
      <div className="relative max-w-md w-full mx-4">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-300 mt-2">Handwerker - Neues Passwort</p>
        </div>
        ...
        {!success && (
          <div className="mt-6 text-center">
            <p className="text-gray-400 text-sm">
              Bei Problemen: <a href="mailto:support@byndl.de" className="text-teal-400 hover:text-teal-300">support@byndl.de</a>
            </p>
          </div>
        )}
      </div>
