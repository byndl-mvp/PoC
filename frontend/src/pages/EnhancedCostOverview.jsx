  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3">
        <h2 className="text-xl sm:text-2xl font-bold text-white">Kostenübersicht</h2>
        ...
        <div className="flex gap-1 sm:gap-2">
          ...
          {(approvedCount > 0 || rejectedCount > 0 || pendingCount > 0) && (
            <button
              ...
              className={`px-2 sm:px-4 py-1.5 sm:py-2 rounded-lg transition-colors relative text-xs sm:text-sm ${
