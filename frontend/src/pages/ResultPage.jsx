...
<button
  ...
  className="text-sm bg-red-600/70 text-white px-3 py-2 rounded-lg hover:bg-red-700 transition-all flex items-center gap-1"
...
>
  ...
  <span className="hidden lg:inline">Gewerk löschen</span>
</button>   
                  </div>
                </div>
